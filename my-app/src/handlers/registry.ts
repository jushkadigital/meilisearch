...
import { handleProductUpdated } from './product.js';
...
const routes: HandlerRoute[] = [
  ...
  // Product events — prefix match: any eventType starting with "product."
  { eventType: 'product.', handler: handleProductUpdated as EventHandler },
];
